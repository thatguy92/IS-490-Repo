...
CREATE TABLE `can_guide` (
  ...
  KEY `fk_can_guide_employee1_idx` (`employee_id`),
  KEY `fk_can_guide_trip_type` (`trip_type_code`),
  CONSTRAINT `fk_can_guide_employee1` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`employee_id`),
  CONSTRAINT `fk_can_guide_trip_type` FOREIGN KEY (`trip_type_code`) REFERENCES `trip_type` (`trip_type_code`)
...
CREATE TABLE `trip` (
  ...
  `estimated_return_time` varchar(45) DEFAULT NULL,
  `destination_code` int(11) NOT NULL,
  `trip_type_code` int(11) NOT NULL,
  ...
  KEY `fk_trip_employee2_idx` (`guide_employee_id`),
  KEY `fk_trip_destination1_idx` (`destination_code`),
  KEY `fk_trip_gathering_point1_idx` (`gathering_point_id`),
  KEY `fk_trip_trip_type1_idx` (`trip_type_code`),
  CONSTRAINT `fk_trip_destination1` FOREIGN KEY (`destination_code`) REFERENCES `destination` (`destination_code`),
  CONSTRAINT `fk_trip_employee1` FOREIGN KEY (`gear_employee_id`) REFERENCES `employee` (`employee_id`),
  CONSTRAINT `fk_trip_employee2` FOREIGN KEY (`guide_employee_id`) REFERENCES `employee` (`employee_id`),
  CONSTRAINT `fk_trip_gathering_point1` FOREIGN KEY (`gathering_point_id`) REFERENCES `gathering_point` (`gathering_point_id`),
  CONSTRAINT `fk_trip_trip_type1` FOREIGN KEY (`trip_type_code`) REFERENCES `trip_type` (`trip_type_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `trip` VALUES (561,'2014-08-02',10,'07:30:00','08:15:00','16:00:00',1,2,4,0,1),(562,'2014-08-02',10,'07:30:00','08:15:00','16:00:00',1,1,3,0,1),(563,'2014-08-09',10,'07:30:00','08:15:00','16:00:00',1,2,4,0,1),(564,'2014-08-09',10,'07:30:00','08:15:00','16:00:00',1,1,3,0,1),(565,'2014-08-16',10,'07:30:00','08:15:00','16:00:00',1,2,4,0,1),(566,'2014-08-16',10,'07:30:00','08:15:00','16:00:00',1,1,3,0,1),(567,'2014-08-23',10,'07:30:00','08:15:00','16:00:00',1,2,4,0,1),(568,'2014-08-23',10,'07:30:00','08:15:00','16:00:00',1,1,3,0,1),(569,'2014-08-30',10,'07:30:00','08:15:00','16:00:00',1,2,4,0,1),(570,'2014-08-30',10,'07:30:00','08:15:00','16:00:00',1,1,3,0,1),(571,'2014-08-02',7,'07:30:00','08:15:00','16:00:00',2,1,2,0,2),(572,'2014-08-09',7,'07:30:00','08:15:00','16:00:00',2,1,2,0,2),(573,'2014-08-16',7,'07:30:00','08:15:00','16:00:00',2,1,2,0,2),(574,'2014-08-23',7,'07:30:00','08:15:00','16:00:00',2,1,2,0,2),(575,'2014-08-30',7,'07:30:00','08:15:00','16:00:00',2,1,2,0,2),(576,'2014-08-02',10,'07:30:00','08:15:00','16:00:00',3,1,1,0,3),(577,'2014-08-02',10,'07:30:00','08:15:00','16:00:00',3,2,7,0,3),(578,'2014-08-09',10,'07:30:00','08:15:00','16:00:00',3,1,1,0,3),(579,'2014-08-09',10,'07:30:00','08:15:00','16:00:00',3,2,7,0,3),(580,'2014-08-16',10,'07:30:00','08:15:00','16:00:00',3,1,1,0,3),(581,'2014-08-16',10,'07:30:00','08:15:00','16:00:00',3,2,7,0,3),(582,'2014-08-23',10,'07:30:00','08:15:00','16:00:00',3,1,1,0,3),(583,'2014-08-23',10,'07:30:00','08:15:00','16:00:00',3,2,7,0,3),(584,'2014-08-30',10,'07:30:00','08:15:00','16:00:00',3,1,1,0,3),(585,'2014-08-30',10,'07:30:00','08:15:00','16:00:00',3,2,7,0,3);
...
-- Dump completed on 2019-05-03 11:48:28
